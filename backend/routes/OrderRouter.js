const { requestOrder, getPendingOrders, getPaidOrders, orderLog, changeOrderStatus, viewMyOrders } = require('../controllers/OrderController');
...
router.get('/:category/get-paid-orders', ensureAuthenticated, checkRole('mess'), getPaidOrders);
